        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h1
                data-aos="fade-left"
                className="text-white fw-semibold display-1"
              >
                Educación Online
              </h1>
              <h5 className="text-white mt-3 mb-4" data-aos="fade-right">
                Una manera mas rapida para el aprendizaje
              </h5>
              <div data-aos="fade-up" data-aos-delay={50}>
                <Link to={"/registro"} className="btn btn-brand me-2">
                  Registrarse
                </Link>
          ...
          <div className="row">
            ...
            >
              <div className="section-title">
                ...
                <div className="line" />
                <p>
                  Aula 503 es una plataforma creada para fortalecer los
                  conocimientos de los estudiantes de educación básica y media.
                </p>
              </div>
            </div>
          </div>
          <div className="row justify-content-between align-items-center">
            ...
            <div data-aos="fade-down" data-aos-delay={150} className="col-lg-5">
              ...
              <p className="mt-3 mb-4">
                Aula 503 posee diversas características para promover el
                aprendizaje en dos áreas
              </p>
              <div className="d-flex pt-4 mb-3">
                ...
                <div>
                  <h5>Ciencias</h5>
                  <p>
                    Aprende los conocimientos en las diferentes ramas de las
                    ciencias naturales
                  </p>
                </div>
              </div>
          ...
          <div className="row">
            ...
            >
              <div className="section-title">
                ...
                <div className="line" />
                <p>
                  Con un total de 4 materias para que te prepares en el tema de
                  las ciencias
                </p>
              </div>
            </div>
          ...
          <div className="row g-4 text-center">
            ...
            >
              <div className="service theme-shadow p-lg-5 p-4">
                ...
                <p>
                  Ciencia natural que estudia, mediante leyes fundamentales, la
                  energía, la materia, el tiempo y el espacio, es decir, el
                  universo mismo.
                </p>
              </div>
            </div>
            ...
            >
              <div className="service theme-shadow p-lg-5 p-4">
                ...
                <p>
                  Ciencia natural que estudia la composición, propiedades de la
                  materia en forma de elementos, especies, compuestos, mezclas u
                  otras sustancias
                </p>
              </div>
            </div>
            ...
            >
              <div className="service theme-shadow p-lg-5 p-4">
                ...
                <p>
                  ...
                  características de los seres vivos, así como sus procesos
                  vitales con el medio ambiente.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <div className="service theme-shadow p-lg-5 p-4">
                ...
                <p>
                  Ciencias cuyo objeto estudio es la interacción social y la
                  influencia del comportamiento humano en el entorno social en
                  el que ocurre.
                </p>
              </div>
            </div>
            ...
            >
              <div className="section-title">
                ...
                <p className="text-white">
                  Si quiere más información sobre el programa, estaremos
                  contentos de ayudarte, por medio del siguiente formulario de
                  contacto.
                </p>
              </div>
            </div>
              ...
              >
                <div className="form-group col-lg-6">
                  <input
                    ...
                    name="primer_nombre"
                    value={contacto.primer_nombre}
                    onChange={ManejarEventoDeInputs}
                  />
                  {alerta
                    .filter(
                      (input) =>
                        input.valorInput == "primer_nombre" &&
                        input.estado === true
                    )
                    .map((message) => (
                      <div>
                ...
                <div className="form-group col-lg-6">
                  <input
                    ...
                    value={contacto.primer_apellido}
                    onChange={ManejarEventoDeInputs}
                  />
                  {alerta
                    .filter(
                      (input) =>
                        input.valorInput == "primer_apellido" &&
                        input.estado === true
                    )
                    .map((message) => (
                      <div>
                ...
                <div className="form-group col-lg-12">
                  ...
                  {alerta
                    .filter(
                      (input) =>
                        input.valorInput == "mensaje" && input.estado === true
                    )
                    .map((message) => (
                      <div>
                        <span className="text-danger">{message.mensaje}</span>
